...
public class MapsPackage implements ReactPackage {
  ...
  public List<ViewManager> createViewManagers(ReactApplicationContext reactContext) {
    ...
    if (hasGoogleMapsOnClasspath()) {
      ...
      List<ViewManager> airMapManagers = Arrays.<ViewManager>asList(calloutManager, annotationManager, polylineManager,
          polygonManager, circleManager, mapManager, mapLiteManager, urlTileManager, localTileManager, overlayManager);
    ...
    if (hasOsmdroidOnClasspath()) {
      ...
      managers.addAll(Arrays.<ViewManager>asList(osmCalloutManager, osmMarkerManager, osmPolylineManager,
          osmPolygonManager, osmMapCircleManager, osmMapManager, osmUrlTileManager));
    }
