...
public class OsmMapManager extends ViewGroupManager<OsmMapView> {
  ...
  void invalidateNode(final OsmMapView view) {
    ...
    appContext.runOnNativeModulesQueueThread(new Runnable() {
      @Override
      public void run() {
        // TODO: very hacky way of forcing layout, discover how to replace (or avoid)
        // this.
  ...
  // public void setMapStyle(AirMapView view, @Nullable String
  ...
  // public void setShowsMyLocationButton(AirMapView view, boolean
  ...
  // public void setShowsIndoorLevelPicker(AirMapView view, boolean
  ...
  // public void setLoadingIndicatorColor(AirMapView view, @Nullable Integer
  ...
  public void receiveCommand(OsmMapView view, int commandId, @Nullable ReadableArray args) {
    ...
    case ANIMATE_TO_REGION:
      ...
      BoundingBox bounds = new BoundingBox(lat + latDelta / 2, lng + lngDelta / 2, // northeast
  ...
  public Map getExportedCustomDirectEventTypeConstants() {
    ...
    map.putAll(MapBuilder.of("onMarkerDragStart", MapBuilder.of("registrationName", "onMarkerDragStart"),
        "onMarkerDrag", MapBuilder.of("registrationName", "onMarkerDrag"), "onMarkerDragEnd",
  ...
  public Map<String, Integer> getCommandsMap() {
    Map<String, Integer> map = MapBuilder.of("setCamera", SET_CAMERA, "animateCamera", ANIMATE_CAMERA);
    map.putAll(MapBuilder.of("animateToRegion", ANIMATE_TO_REGION, "animateToCoordinate", ANIMATE_TO_COORDINATE,
        "animateToViewingAngle", ANIMATE_TO_VIEWING_ANGLE, "animateToBearing", ANIMATE_TO_BEARING, "fitToElements",
        FIT_TO_ELEMENTS, "fitToSuppliedMarkers", FIT_TO_SUPPLIED_MARKERS, "fitToCoordinates", FIT_TO_COORDINATES));
    return map;
  }
